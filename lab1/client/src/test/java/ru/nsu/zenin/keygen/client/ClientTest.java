...
class ClientTest {
    ...
    private static final X500Name name =
            new X500Name("CN=Test Certificate, O=My Organization, C=RU");
    private static final X500Name clientsName =
            new X500Name("CN=Test Certificate, O=NOTMy Organization, C=RU");
    ...
    static void startServer() throws Exception {
        InetSocketAddress addr =
                new InetSocketAddress(InetAddress.getLoopbackAddress(), SERVER_PORT);
        ...
        KeypairAndCertGenerator generator =
                new KeypairAndCertGenerator(name, signer, keypairGenerator, certLifetime);
